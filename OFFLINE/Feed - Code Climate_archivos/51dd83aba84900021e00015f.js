...
_pa.segments = [{"name":"All visitors","id":844270,"regex":".*"},{"name":"Viewed Private Repo","id":1360771,"regex":"^\\/repos\\/.*"},{"name":"Tour","id":1647250,"regex":"/tour.*/?([?#].*)*$"},{"name":"Pricing","id":1647249,"regex":"/pricing.*/?([?#].*)*$"},{"name":"All visitors (7 days)","id":1647247,"regex":".*"},{"name":"Viewed Dashboard","id":1359833,"regex":"/dashboard/?([?#].*)*$"},{"name":"Blog","id":1390336,"regex":"/blog.*/?([?#].*)*$"},{"name":"Blog subdomain","id":1734412,"regex":"blog\\.codeclimate\\.com"}];
_pa.conversions = [{"name":"Created Account","id":"146377","regex":"/github_link/cta/?([?#].*)*$"}];
_pa.conversionEvents = [];
_pa.segmentEvents = [{"name":"Created Account","id":1360758},{"name":"Viewed Metrics","id":1359832}];
_pa.thirdPartyTags = [];
_pa.thirdPartyTagEvents = [];
_pa.allVisitorsSegmentId = 844270;
_pa.clickThroughWindow = 30;
_pa.viewThroughWindow = 30;
_pa.rtbId = '7702';
_pa.siteId = '51dd83aba84900021e00015f';
