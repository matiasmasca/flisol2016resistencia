  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype.start = function(force) {
        ...
        $(document).off("click.bootstrap-tour", ".popover *[data-role=next]").on("click.bootstrap-tour", ".popover *[data-role=next]:not(.disabled)", (function(_this) {
          return function(e) {
            e.preventDefault();
            return _this.next();
          };
        })(this));
        $(document).off("click.bootstrap-tour", ".popover *[data-role=prev]").on("click.bootstrap-tour", ".popover *[data-role=prev]:not(.disabled)", (function(_this) {
          return function(e) {
            e.preventDefault();
            return _this.prev();
          };
        })(this));
        $(document).off("click.bootstrap-tour", ".popover *[data-role=end]").on("click.bootstrap-tour", ".popover *[data-role=end]", (function(_this) {
          return function(e) {
            e.preventDefault();
            return _this.end();
          };
      ...
      Tour.prototype._showPopover = function(step, i) {
        ...
        if (step.reflex) {
          $(step.element).css("cursor", "pointer").on("click.bootstrap-tour", (function(_this) {
            return function(e) {
      ...
      Tour.prototype._setupKeyboardNavigation = function() {
        if (this._options.keyboard) {
          return $(document).on("keyup.bootstrap-tour", (function(_this) {
            return function(e) {
              if (!e.which) {
                return;
              }
...
(function() {
  window.messages = {
    enableMessages: function(select_part) {
      $('body').tooltip({
        selector: '[rel=tooltip]'
      });
      $('a[data-remote=true]').not('.ignore-actions').click(function() {
        return $(this).fadeOut('slow', function() {
          return $(this).detach();
        });
      });
      $(select_part + ' a[data-remote=true]').bind("ajax:error", function(xhr, status, error) {
        return $("#status_bar").append("<div class='alert alert-error'>An error occurred while processing your request.</p>");
      }).bind("ajax:success", function(event, data, status, xhr) {
        return $("#status_bar").append("<div class='alert alert-info'> <button class='close' data-dismiss='alert' type='button'>×</button><strong><i class='fa fa-info-circle'></i> Just so you know …</strong> <p>" + data.message + "</p></div>");
      });
      return $('.popover').on('click', '.close', function() {
        return $(this).closest('.popover').siblings('[rel=popover]').tooltip('hide');
      });
    }
  };
  ...
  $(function() {
    ...
    $('.accordion-body').on('shown', function() {
      return $(this).parent().find(".fa-caret-right").removeClass("fa-caret-right").addClass("fa-caret-down");
    });
    $('.accordion-body').on('hidden', function() {
      return $(this).parent().find(".fa-caret-down").removeClass("fa-caret-down").addClass("fa-caret-right");
    });
    $(".dropdown-menu li a").click(function() {
      $(this).parent().parent().parent().find(".btn:first-child").text($(this).text());
      return $(this).parent().parent().parent().find(".btn:first-child").val($(this).text());
    });
    $('.ignore-setting').hover(function() {
      return $(this).html("<i class='icon-remove'></i>&nbsp;Stop Ignoring");
    }, function() {
      return $(this).html("<i class='icon-ok'></i>&nbsp;Ignoring");
    });
    $('.notification-disabled-setting').hover(function() {
      return $(this).html("<i class='icon-ok'></i>&nbsp;Enable notifications");
    }, function() {
      return $(this).html("<i class='icon-envelope'></i>&nbsp;Disabled");
    });
    return $('.notification-enabled-setting').hover(function() {
      return $(this).html("<i class='icon-remove'></i>&nbsp;Stop notifying me");
    }, function() {
      return $(this).html("<i class='icon-envelope'></i>&nbsp;Enabled");
    });
  });
